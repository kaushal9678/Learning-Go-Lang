...
import (
	...
	"github.com/kaushal9678/go-fiber-postgres/models"
	"github.com/kaushal9678/go-fiber-postgres/storage"
	"gorm.io/gorm"
)
...
func (r *Repository) CreateBook(context *fiber.Ctx) error{
	book := Book{}
	err := context.BodyParser(&book); if err != nil{
		context.Status(http.StatusUnprocessableEntity).JSON(&fiber.Map{"message":"request failed"})
		return err;
	}
	err = r.DB.Create(&book).Error;if err != nil{
...
func (r *Repository)GetBooks(context *fiber.Ctx) error{
	...
	err := r.DB.Find(bookModels).Error; if err != nil{
...
func (r *Repository) GetBookById(context *fiber.Ctx) error{
	...
	if id == ""{
		context.Status(http.StatusUnprocessableEntity).JSON(&fiber.Map{"message":"id is required"})
		return nil;
	}
	err := r.DB.First(&book, id).Error; if err != nil{
...
func (r *Repository) DeleteBook(context *fiber.Ctx) error{
	...
	err := r.DB.Delete(&book, id).Error; if err != nil{
